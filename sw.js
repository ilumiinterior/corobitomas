const CACHE = 'tomas-v2';
const ASSETS = ['./','./index.html','./style.css','./chaos.css','./app.js','./data.js','./tomas.jpeg','./jakub.png','./klara.jpg','./manifest.webmanifest','./icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
