const CACHE = 'tomas-v4';
const ASSETS = ['./','./index.html','./style.css','./app.js','./data.js','./tomas.jpeg','./jakub.png','./klara.jpg','./manifest.webmanifest','./icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
